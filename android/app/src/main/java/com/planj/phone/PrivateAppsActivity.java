...
/** Pick which apps are recorded only as "Private". Money, passwords, health and dating start ticked. */
public class PrivateAppsActivity extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_day);
        findViewById(R.id.back).setOnClickListener(v -> finish());
        ((TextView) findViewById(R.id.title)).setText("Private apps");
        ((TextView) findViewById(R.id.subtitle)).setText("Ticked apps are recorded only as \"Private\" — time counts, the app is never named.");
        ...
        Set<String> chosen = PrivateMode.privateApps(this);
        ...
        for (ResolveInfo info : apps) {
            ...
            box.setChecked(PrivateMode.isPrivateApp(this, pkg));
